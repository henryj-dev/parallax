...
export const messages = Object.freeze({
  en: {
    ...
    "credentials.probeZoneId": "Zone ID used to test this token",
    ...
    "credentials.probeZoneIdRequired": "Enter a Cloudflare zone ID to test this token against.",
  ...
  ko: {
    ...
    "credentials.sections": "프로바이더 설정 섹션", "credentials.profilesTab": "자격 증명 프로필", "credentials.bindingsTab": "Apex 도메인", "credentials.profilesConfigured": "저장된 프로필", "credentials.profileEditor": "프로필", "credentials.bindingEditor": "Apex 도메인", "credentials.profileName": "프로필 이름", "credentials.profileNamePlaceholder": "production-account", "credentials.profileTokenPlaceholder": "쓰기 전용. 교체하려면 다시 입력하세요", "credentials.accountId": "Cloudflare 계정 ID", "credentials.accountIdValue": "계정 {id}", "credentials.accountIdMissing": "기록된 계정 ID 없음", "credentials.probeZoneId": "이 토큰을 테스트할 존 ID", "credentials.profile": "자격 증명 프로필", "credentials.profileValue": "프로필 {name}", "credentials.profileSave": "프로필 저장", "credentials.profileDelete": "프로필 삭제", "credentials.profilesNone": "아직 자격 증명 프로필이 없습니다. 하나 만들면 여러 도메인에서 토큰을 재사용할 수 있습니다.", "credentials.profileUnused": "아직 어떤 apex 도메인도 사용하지 않음", "credentials.profileSaved": "{name} 프로필을 저장했습니다.", "credentials.profileDeleted": "{name} 프로필을 삭제했습니다.", "credentials.profileAccepted": "Cloudflare가 {name} 프로필을 승인했습니다.", "credentials.profileDeleteConfirm": "{name} 자격 증명 프로필을 삭제할까요?", "credentials.profileInUse": "이 프로필을 사용 중인 apex 도메인이 있습니다. 해당 연결을 먼저 제거하세요.", "credentials.profileTokenRequired": "프로필을 저장하려면 API 토큰이 필요합니다.", "credentials.profileNameRequired": "프로필 이름을 먼저 입력하세요.", "credentials.probeZoneIdRequired": "이 토큰을 테스트할 Cloudflare 존 ID를 입력하세요.", "credentials.profileRequired": "이 apex 도메인에 사용할 자격 증명 프로필을 선택하세요.", "credentials.eyebrow": "관리자 설정", "credentials.title": "Cloudflare 자격 증명", "credentials.body": "프로필 하나가 계정 ID와 API 토큰을 담으며 여러 apex 도메인이 재사용할 수 있습니다. 토큰은 서버에서 암호화되고 이 포털로 반환되지 않습니다.", "credentials.configured": "설정된 apex 도메인", "credentials.current": "현재 존", "credentials.zone": "Apex 도메인", "credentials.zoneId": "Cloudflare 존 ID", "credentials.apiToken": "API 토큰", "credentials.tokenPlaceholder": "저장된 토큰을 테스트하려면 비워 두세요", "credentials.delete": "연결 제거", "credentials.test": "연결 테스트", "credentials.save": "연결 저장", "credentials.selectZone": "프로바이더 자격 증명을 설정하기 전에 존을 선택하세요.", "credentials.adminView": "프로바이더 자격 증명을 보거나 변경하려면 관리자 권한이 필요합니다.", "credentials.disabled": "이 서버에서 암호화 자격 증명 관리가 활성화되지 않았습니다.", "credentials.loadFailed": "프로바이더 설정을 불러오지 못했습니다: {error}", "credentials.zoneIdValue": "존 ID {id}", "credentials.updated": "업데이트 {date}", "credentials.none": "아직 프로필에 연결된 apex 도메인이 없습니다.", "credentials.required": "자격 증명을 저장하려면 존 ID와 새 API 토큰이 필요합니다.", "credentials.saved": "{zone}을(를) 자격 증명 프로필에 연결했습니다.", "credentials.adminSave": "자격 증명을 저장하려면 관리자 권한이 필요합니다.", "credentials.saveFailed": "자격 증명을 저장하지 못했습니다: {error}", "credentials.testNeedsZoneId": "새 토큰을 테스트하기 전에 Cloudflare 존 ID를 입력하세요.", "credentials.accepted": "Cloudflare가 {zone}의 자격 증명을 승인했습니다.", "credentials.adminTest": "자격 증명을 테스트하려면 관리자 권한이 필요합니다.", "credentials.testFailed": "연결 테스트 실패: {error}", "credentials.deleteConfirm": "{zone}의 프로바이더 연결을 제거할까요? 프로필 자체는 유지됩니다.", "credentials.deleted": "{zone}의 프로바이더 연결을 제거했습니다.", "credentials.adminDelete": "자격 증명을 삭제하려면 관리자 권한이 필요합니다.", "credentials.deleteFailed": "자격 증명을 삭제하지 못했습니다: {error}", "validation.required": "{field}: 필수 입력 항목입니다.", "validation.number": "{field}: 올바른 숫자를 입력하세요.", "validation.min": "{field}: {min} 이상이어야 합니다.", "validation.max": "{field}: {max} 이하여야 합니다.", "validation.step": "{field}: {step} 단위로 입력하세요.", "date.unknown": "알 수 없음", "ttl.auto": "자동", "ttl.seconds": "{seconds}초", "ttl.label": "TTL {value}"
  }
});
