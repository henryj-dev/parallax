...
export const messages = Object.freeze({
  ...
  ko: {
    ...
    "auth.eyebrow": "보호된 컨트롤 플레인", "auth.title": "접근 토큰 입력", "auth.body": "이 서버에는 관리자, 편집자 또는 뷰어 토큰이 필요합니다. 토큰은 이 페이지의 스크립트가 읽을 수 없는 세션 쿠키로 교환됩니다.", "auth.signOut": "로그아웃", "auth.token": "접근 토큰", "auth.open": "컨트롤 플레인 열기", "auth.or": "또는", "auth.identity": "조직 계정으로 로그인", "auth.identityHint": "역할은 인증 제공자에서 옵니다. 관리자가 거기서 부여합니다.", "auth.forbidden": "이 토큰으로 컨트롤 플레인을 열 수 없습니다.", "auth.rejected": "토큰이 승인되지 않았습니다.",
