...
export const messages = Object.freeze({
  en: {
    ...
    "zone.deleteConfirm": "Delete {name}? Its desired state is removed and every record Parallax published for it is withdrawn from the DNS provider. Records Parallax does not manage are left alone. Provider targets that cannot be read are abandoned rather than blocking the deletion. This cannot be undone.",
    ...
    "zone.deletedAbandoned.one": "1 provider target could not be read, so the records Parallax published to it were left in place and are no longer tracked: {targets}. Remove them at the provider.",
    "zone.deletedAbandoned.other": "{count} provider targets could not be read, so the records Parallax published to them were left in place and are no longer tracked: {targets}. Remove them at the provider.",
    ...
    "sync.unpublishedInternal": "Nothing publishes this view and no listener answers it, so no revision can be applied to it. Set PARALLAX_DNS_PORT to answer it from this process, or configure a server to publish it into.",
    "sync.unpublishedExternal": "No DNS provider is configured for this zone, so no revision can be applied to it. Bind the apex domain to a credential profile.",
    ...
    "history.loadMore": "Load older changes",
    "history.loading": "Loading…",
    "revisions.loadMore": "Load older revisions",
    ...
    "plan.recordBehind": "Desired and actual state already match, but this zone is recorded as applied at revision {applied}. Applying advances that record to {desired} without writing to any provider.",
    ...
    "apply.viewsFailed": "The provider refused {views}: {error}",
    "apply.viewsFailedPartial": "The provider refused {views} after {completed} of {planned} changes: {error}",
    ...
    "fallback.set": "Add suffix",
    "fallback.delete": "Remove",
    "fallback.suffix": "Suffix",
    "fallback.dnsServer": "Resolver addresses",
    "fallback.setFailed": "Could not set the suffix: {error}",
    "fallback.deleteFailed": "Could not remove the suffix: {error}",
    "fallback.deleteConfirm": "Stop overriding {suffix}?",
    "fallback.added": "Override added for {suffix}.",
    "fallback.updated": "Override updated for {suffix}.",
    "fallback.removed": "Override removed for {suffix}.",
    "fallback.unchanged": "The override for {suffix} was already in that state.",
    "history.all": "All zones",
    "history.thisZone": "This zone",
    "history.noneGlobal": "No changes have been recorded.",
  ...
  ko: {
    ...
    "nav.skip": "작업 영역으로 건너뛰기", "nav.home": "Parallax 홈", "brand.subtitle": "DNS 관측소", "nav.apiReference": "API 문서", "provider.settings": "프로바이더 설정", "status.controlPlane": "컨트롤 플레인", "status.connecting": "연결 중", "status.online": "컨트롤 플레인 온라인", "status.unavailable": "컨트롤 플레인에 연결할 수 없음",
