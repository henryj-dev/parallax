...
export const messages = Object.freeze({
  en: {
    ...
    "auth.body": "This server requires an administrator, editor, or viewer token. The token is kept only in this browser tab.",
    ...
    "credentials.body": "Credentials are encrypted by the server. API tokens are write-only and are never returned to this portal.",
    "credentials.configured": "Configured zones",
    "credentials.current": "Current zone",
    "credentials.zone": "Zone",
    "credentials.zoneId": "Cloudflare zone ID",
    "credentials.apiToken": "API token",
    "credentials.tokenPlaceholder": "Leave empty to test the saved token",
    "credentials.delete": "Delete saved credential",
    ...
    "credentials.none": "No encrypted credentials are configured.",
    "credentials.required": "A zone ID and a new API token are required to save a credential.",
    "credentials.saved": "Cloudflare credential saved for {zone}.",
    ...
    "credentials.testNeedsZoneId": "Enter the Cloudflare zone ID before testing a new token.",
    ...
    "credentials.deleteConfirm": "Delete the encrypted Cloudflare credential for {zone}?",
    "credentials.deleted": "Encrypted credential deleted for {zone}.",
  ...
  ko: {
    ...
    "auth.eyebrow": "보호된 컨트롤 플레인", "auth.title": "접근 토큰 입력", "auth.body": "이 서버에는 관리자, 편집자 또는 뷰어 토큰이 필요합니다. 토큰은 현재 브라우저 탭에만 보관됩니다.", "auth.token": "접근 토큰", "auth.open": "컨트롤 플레인 열기", "auth.forbidden": "이 토큰으로 컨트롤 플레인을 열 수 없습니다.", "auth.rejected": "토큰이 승인되지 않았습니다.",
    ...
    "credentials.eyebrow": "관리자 설정", "credentials.title": "Cloudflare 자격 증명", "credentials.body": "자격 증명은 서버에서 암호화됩니다. API 토큰은 쓰기 전용이며 이 포털로 반환되지 않습니다.", "credentials.configured": "설정된 존", "credentials.current": "현재 존", "credentials.zone": "존", "credentials.zoneId": "Cloudflare 존 ID", "credentials.apiToken": "API 토큰", "credentials.tokenPlaceholder": "저장된 토큰을 테스트하려면 비워 두세요", "credentials.delete": "저장된 자격 증명 삭제", "credentials.test": "연결 테스트", "credentials.save": "자격 증명 저장", "credentials.selectZone": "프로바이더 자격 증명을 설정하기 전에 존을 선택하세요.", "credentials.adminView": "프로바이더 자격 증명을 보거나 변경하려면 관리자 권한이 필요합니다.", "credentials.disabled": "이 서버에서 암호화 자격 증명 관리가 활성화되지 않았습니다.", "credentials.loadFailed": "프로바이더 설정을 불러오지 못했습니다: {error}", "credentials.zoneIdValue": "존 ID {id}", "credentials.updated": "업데이트 {date}", "credentials.none": "설정된 암호화 자격 증명이 없습니다.", "credentials.required": "자격 증명을 저장하려면 존 ID와 새 API 토큰이 필요합니다.", "credentials.saved": "{zone}의 Cloudflare 자격 증명을 저장했습니다.", "credentials.adminSave": "자격 증명을 저장하려면 관리자 권한이 필요합니다.", "credentials.saveFailed": "자격 증명을 저장하지 못했습니다: {error}", "credentials.testNeedsZoneId": "새 토큰을 테스트하기 전에 Cloudflare 존 ID를 입력하세요.", "credentials.accepted": "Cloudflare가 {zone}의 자격 증명을 승인했습니다.", "credentials.adminTest": "자격 증명을 테스트하려면 관리자 권한이 필요합니다.", "credentials.testFailed": "연결 테스트 실패: {error}", "credentials.deleteConfirm": "{zone}의 암호화된 Cloudflare 자격 증명을 삭제할까요?", "credentials.deleted": "{zone}의 암호화된 자격 증명을 삭제했습니다.", "credentials.adminDelete": "자격 증명을 삭제하려면 관리자 권한이 필요합니다.", "credentials.deleteFailed": "자격 증명을 삭제하지 못했습니다: {error}", "validation.required": "{field}: 필수 입력 항목입니다.", "validation.number": "{field}: 올바른 숫자를 입력하세요.", "validation.min": "{field}: {min} 이상이어야 합니다.", "validation.max": "{field}: {max} 이하여야 합니다.", "validation.step": "{field}: {step} 단위로 입력하세요.", "date.unknown": "알 수 없음", "ttl.auto": "자동", "ttl.seconds": "{seconds}초", "ttl.label": "TTL {value}"
  }
});
